...
import BrentEachApproveUserData from "./BrentEachApproveUserData";
export default class BrentApproveUserData extends React.Component {
  // getNow=(_id,obj)=>{

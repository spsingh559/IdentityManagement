...
// import TAPendingServiceDetail from './BrentCreateServiceTAPendingServiceDetail';
// import TAApproveServiceDetail from './BrentCreateServiceTAApproveServiceDetail';
...
addSchema=(e)=>{
  e.preventDefault();
    let newObj=[{name:this.state.schemaName}].concat(this.state.schemaData)
...
handleRequestClose=()=>{
  this.setState({open:false});
      ...
      render(){
        ...
        return(
            ...
            <div style={{backgroundColor:"black", color:"white", height:"40px", padding:"0px 5px"}}>
               <center> <h4> <span onTouchTap={this.goBack}><ActionHome color="white" style={{marginRight:"10px"}} /></span>Regulate Services </h4> </center>
         </div>
         <Tabs>
    <Tab
      icon={<Draft />}
   ...
   <Grid style={{marginTop:"20 px"}}>
    ...
    <BrentShowSchema data={this.state.schemaData} deleteAttrName={this.deleteAttrName}/>
    </div>
